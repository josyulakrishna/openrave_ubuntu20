...
function _complete_openravepy {
        ...
        if [[ $COMP_CWORD == 2 ]]; then
            case ${COMP_WORDS[1]} in
                --listinterfaces)
                    ...
                    ;;
                --example)
                    opts=`openrave0.53.py --listexamples`
                    COMPREPLY=($(compgen -W "$opts" -- ${cur}))
                    return 0
                    ;;
                --database)
                    opts=`openrave0.53.py --listdatabases`
                    COMPREPLY=($(compgen -W "$opts" -- ${cur}))
                    return 0
                    ;;
            esac
    ...
    case "${prev}" in
        --level|-l)
            ...
            ;;
        --collision)
            opts=`openrave0.53.py --listinterfaces collisionchecker`
            COMPREPLY=($(compgen -W "$opts" -- ${cur}))
            return 0
            ;;
        --viewer)
            opts=`openrave0.53.py --listinterfaces viewer`
            COMPREPLY=($(compgen -W "$opts" -- ${cur}))
            return 0
            ;;
        --physics)
            opts=`openrave0.53.py --listinterfaces physics`
            COMPREPLY=($(compgen -W "$opts" -- ${cur}))
            return 0
            ;;
        --loadplugin)
...
complete -F "_complete_openravepy" -o filenames -o plusdirs "openrave0.53.py"
complete -F "_complete_openrave_robotpy" -o filenames -o plusdirs "openrave0.53-robot.py"
complete -F "_complete_openrave_createpluginpy" "openrave0.53-createplugin.py"
