...
#define OPENRAVE_VERSION_MINOR 53
#define OPENRAVE_VERSION_PATCH 1
...
#define OPENRAVE_VERSION_STRING "0.53.1"
...
#define OPENRAVE_PLUGINS_INSTALL_DIR "/usr/local/lib/openrave0.53-plugins"
#define OPENRAVE_DATA_INSTALL_DIR "/usr/local/share/openrave-0.53"
#define OPENRAVE_PYTHON_INSTALL_DIR "/usr/local/lib/python3.9/site-packages"
#define OPENRAVE_LOCALE_INSTALL_DIR "/usr/local/share/locale"

// the python path that OpenRAVE was compiled with
#define OPENRAVE_PYTHON_EXECUTABLE "/home/josyula/miniconda3/bin/python"

// whether log4cxx is to be used
#define OPENRAVE_LOG4CXX 1

// whether msgpack is to be used
#define OPENRAVE_MSGPACK 0
