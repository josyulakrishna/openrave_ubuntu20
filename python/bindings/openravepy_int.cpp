...
void toRapidJSONValue(const object &obj, rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator)
{
    ...
    {
#ifdef USE_PYBIND11_PYTHON_BINDINGS// value.SetInt64(PyInt_AsLong(obj.ptr()));
...
#endif
    else if (PyUnicode_Check(obj.ptr())) //PyString_Check
    {
        value.SetString(PyBytes_AsString(obj.ptr()), PyUnicode_GET_SIZE(obj.ptr()), allocator);
    }
